defmodule LiveAiChatWeb.Components.FileField do
  @moduledoc """
  The `LiveAiChatWeb.Components.FileField` module provides a versatile and customizable component
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveAiChatWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveAiChatWeb.Gettext, "errors", msg, opts)
    end
  end
end
