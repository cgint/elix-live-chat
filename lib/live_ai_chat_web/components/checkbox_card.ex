defmodule LiveAiChatWeb.Components.CheckboxCard do
  @moduledoc """
  The `LiveAiChatWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
