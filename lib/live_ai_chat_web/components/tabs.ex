defmodule LiveAiChatWeb.Components.Tabs do
  @moduledoc """
  `LiveAiChatWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import LiveAiChatWeb.Components.Badge, only: [badge: 1]
