defmodule LiveAiChatWeb.Components.CheckboxField do
  @moduledoc """
  LiveAiChatWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
