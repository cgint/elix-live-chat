defmodule LiveAiChatWeb.Components.Menu do
  @moduledoc """
  The `LiveAiChatWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `LiveAiChatWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import LiveAiChatWeb.Components.Accordion, only: [accordion: 1]
  import LiveAiChatWeb.Components.Button, only: [button_link: 1]
