defmodule LiveAiChatWeb.Components.Alert do
  @moduledoc """
  LiveAiChatWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
