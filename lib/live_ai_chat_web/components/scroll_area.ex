defmodule LiveAiChatWeb.Components.ScrollArea do
  @moduledoc """
  The `LiveAiChatWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
