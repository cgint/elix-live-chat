defmodule LiveAiChatWeb.Components.Divider do
  @moduledoc """
  The `LiveAiChatWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `LiveAiChatWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
