defmodule LiveAiChatWeb.Components.MegaMenu do
  @moduledoc """
  The `LiveAiChatWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
