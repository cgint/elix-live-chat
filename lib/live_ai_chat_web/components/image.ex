defmodule LiveAiChatWeb.Components.Image do
  @moduledoc """
  The `LiveAiChatWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
