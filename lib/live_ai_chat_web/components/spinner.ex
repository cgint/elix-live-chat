defmodule LiveAiChatWeb.Components.Spinner do
  @moduledoc """
  The `LiveAiChatWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `LiveAiChatWeb.Components.Spinner` module enables developers to provide
