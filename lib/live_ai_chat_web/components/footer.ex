defmodule LiveAiChatWeb.Components.Footer do
  @moduledoc """
  The `LiveAiChatWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
