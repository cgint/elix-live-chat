defmodule LiveAiChatWeb.Components.Overlay do
  @moduledoc """
  The `LiveAiChatWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `LiveAiChatWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
