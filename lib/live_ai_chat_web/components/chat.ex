defmodule LiveAiChatWeb.Components.Chat do
  @moduledoc """
  `LiveAiChatWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
