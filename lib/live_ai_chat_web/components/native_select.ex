defmodule LiveAiChatWeb.Components.NativeSelect do
  @moduledoc """
  The `LiveAiChatWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `LiveAiChatWeb.Components.NativeSelect`
